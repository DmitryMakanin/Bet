...
<div class="well well-small">
	<h4>Редактирование сезонов</h4>
	<p>Измените необходимые поля и примените изменения кнопкой Редактировать.</p>
</div>

<?php echo $this->tag->form(array('season/edit', 'method' => 'POST', 'class' => 'form-horizontal')); ?>
	<input type="hidden" name="curr_season_id" value="<?php echo $curr_season_id; ?>" />

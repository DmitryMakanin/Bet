...
<?php echo $this->tag->form(array('sportkind/edit', 'method' => 'POST', 'class' => 'form-horizontal')); ?>
	<input type="hidden" name="curr_sportkind_id" value="<?php echo $curr_sportkind_id; ?>" />
